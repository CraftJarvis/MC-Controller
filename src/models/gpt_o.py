...
from src.models.mha_o import MHA, ParallelMHA
from flash_attn.modules.mlp import Mlp, FusedMLP, ParallelFusedMLP
# from flash_attn.modules.block import Block
from src.models.block_o import Block # HJ
    ...
    def forward(self, input_ids, position_ids=None, inference_params=None):
        ...
        for layer in self.layers:
            if self.prenorm:
                ...
                # hidden_states, residual = hidden_states.half(), residual.half()
            else:
...
class GPTLMHeadModel(GPTPreTrainedModel, GenerationMixin):
    ...
    def forward(self, input_ids, position_ids=None, inference_params=None, only_return_hidden_states=False):
        """
